...
<body>
    ...
    <div class="nom-prenom">
        ...
        <div><?php echo (htmlspecialchars($user["place"]) ? htmlspecialchars($user["place"]) : "Monde"); ?></div>
        <div><?php echo (htmlspecialchars($user["user_description"]) ? htmlspecialchars($user["user_description"]) : "Recrutez moi !"); ?></div>
    </div>
